...
function disk_watch()
    ...
    disk=tonumber(conky_parse("${fs_used_perc /media/michael/wd1000}"))
...
function iface_watch()
    ...
    iface=conky_parse("${if_existing /proc/net/route enp2s0}enp2s0${else}wlp1s0${endif}")
